...
public class AddLogerClient{
	public static Socket socket;
	public static PrintStream output ;
	public static BufferedReader input ;
	String message="";
	ArrayList<String> messages = new ArrayList<String>();
	public AddLogerClient(){
		
	}
	//参数要改。。
	public String connect(String roomName ,String friName ,  String roomMaster ){
		...
		try{
			...
			//输出数据流
			output.println("操作 允许加入房间 "+roomName+" "+friName+" "+roomMaster);
			output.flush();
