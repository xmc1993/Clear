...
public class CreateRoom2Client {
	public static Socket socket;
	public static PrintStream output ;
	public static BufferedReader input ;
	String message="";
	ArrayList<String> messages = new ArrayList<String>();
	public CreateRoom2Client(){
		
	}
	//参数要改。。
	public String connect(String roomName ,String userName ,  int size , int size2){
		...
		try{
			...
			output.flush();
			output.println("操作 创建房间2 "+roomName+" "+size+" "+size2+" "+userName);
			output.flush();
